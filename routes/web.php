...
Route::get('threads/create', 'ThreadsController@create')->middleware(['must-be-confirmed', 'must-be-active'])->name('threads.create');
Route::get('threads/search', 'SearchController@show')->name('search.show');
Route::get('threads/{channel}/{thread}', 'ThreadsController@show')->name('threads.show');
Route::patch('threads/{channel}/{thread}', 'ThreadsController@update')->name('threads.update');
Route::delete('threads/{channel}/{thread}', 'ThreadsController@destroy')->name('threads.destroy');
Route::post('threads', 'ThreadsController@store')->middleware(['must-be-confirmed', 'must-be-active'])->name('threads.store');
...
Route::post('/threads/{channel}/{thread}/replies', 'RepliesController@store')->middleware(['must-be-confirmed', 'must-be-active'])->name('replies.store');
